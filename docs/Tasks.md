...
**目标：** 提供 Unit 下的单词批量录入入口。

- [x] 手动批量录入（CSV 风格文本：`英文,中文`）
- [x] AI 自然语言解析（粘贴文本 → 提取英语词条）
- [x] AI Provider 抽象层实现（Claude / DeepSeek / GLM）
- [x] 单元测试
- [x] Review

**交付物：** 手动录入 / AI 文本解析 → 返回单词列表 → 用户确认 → 存入数据库。
...
- [x] AI Provider 具体实现（Claude / DeepSeek）
- [x] 场景对话生成接口
- [x] AI 练习题生成接口
- [x] 前端场景对话页面
- [x] Review
